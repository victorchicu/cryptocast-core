...
import com.trader.core.binance.client.domain.account.request.CancelOrderListResponse;
import com.trader.core.binance.client.domain.account.request.CancelOrderResponse;
...
public interface BinanceApiService {
    ...
    @GET
    Call<BinanceResponse<List<Asset>>> getAllAssets(@Url String url);

    @Headers({BinanceApiConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER, BinanceApiConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER})
    @POST
    Call<BinanceResponse<List<UserAsset>>> getUserAssets(@Url String url, @Query("needBtcValuation") boolean needBtcValuation);

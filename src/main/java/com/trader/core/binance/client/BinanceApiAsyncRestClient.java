package com.trader.core.binance.client;

import com.trader.core.binance.client.domain.account.*;
import com.trader.core.binance.client.domain.account.request.*;
import com.trader.core.binance.client.domain.event.ListenKey;
import com.trader.core.binance.client.domain.general.BinanceResponse;
import com.trader.core.binance.client.domain.general.ExchangeInfo;
import com.trader.core.binance.client.domain.general.ServerTime;
import com.trader.core.binance.client.domain.general.UserAsset;
import com.trader.core.binance.client.domain.market.*;
import com.trader.core.binance.client.domain.wallet.Asset;
...
public interface BinanceApiAsyncRestClient {
   ...
   */
  void getAllAssets(BinanceApiCallback<BinanceResponse<List<Asset>>> callback);

  /**
   * @return All the user assets and whether or not they can be withdrawn.
   */
  void getUserAssets(boolean needBtcValuation, BinanceApiCallback<BinanceResponse<List<UserAsset>>> callback);
  ...
  /**
   * List all fiat and spot assets
   * @param recvWindow
   * @param timestamp
   * @param callback the callback that handles the response with a list of assets
   */
  void listAssets(Long recvWindow, Long timestamp, BinanceApiCallback<List<Asset>> callback);
}

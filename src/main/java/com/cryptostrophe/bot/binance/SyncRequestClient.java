...
import com.cryptostrophe.bot.binance.model.ResponseResult;
import com.cryptostrophe.bot.binance.model.market.*;
import com.cryptostrophe.bot.binance.model.enums.*;
import com.cryptostrophe.bot.binance.model.trade.*;
 ...
 * {@link com.cryptostrophe.bot.binance.exception.BinanceApiException} will be thrown.
 */
public interface SyncRequestClient {
    ...
    static SyncRequestClient create() {
        return create("", "", new com.cryptostrophe.bot.binance.RequestOptions());
    }
    ...
    static SyncRequestClient create(String apiKey, String secretKey) {
        return BinanceApiInternalFactory.getInstance().createSyncRequestClient(apiKey, secretKey, new com.cryptostrophe.bot.binance.RequestOptions());
    }
     ...
     * @return The instance of synchronous client.
     */
    static SyncRequestClient create(String apiKey, String secretKey, com.cryptostrophe.bot.binance.RequestOptions options) {
